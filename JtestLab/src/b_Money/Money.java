...
public class Money implements Comparable {
	...
	public String toString() {
		...
		return am.substring(0, am.length() - 2) + "." + am.substring(am.length() - 1, am.length()) + " " + currency.getName();
	}
	...
	public Money sub(Money other) {
		Integer subs = amount - currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(subs, currency);
	}
